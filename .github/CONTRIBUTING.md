# Contributing to Derrick Plugin SDK
...
* Fix a [bug](https://github.com/nomatronio/derrick-plugin-sdk/labels/bug).
* Implement a requested [enhancement](https://github.com/nomatronio/derrick-plugin-sdk/labels/enhancement).
...
2. The issue is verified and categorized by a Derrick maintainer.
...
## Building Derrick Plugin SDK

TODO

## Making Changes to Derrick Plugin SDK
...
1. Navigate to `$GOPATH/src/github.com/nomatronio/derrick-plugin-sdk`
...
3. Add your fork as a remote by running
   ...
   `git remote add origin https://github.com/myusername/derrick-plugin-sdk`.
